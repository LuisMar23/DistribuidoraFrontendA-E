...
import { faUserTie, faEdit, faTrashAlt, faIdCard, faPhoneAlt, faMapMarkerAlt, faBuilding, faEnvelope, faToggleOn, faCalendarAlt, faSpinner, faExclamationTriangle, faHome, faShop } from '@fortawesome/free-solid-svg-icons';
